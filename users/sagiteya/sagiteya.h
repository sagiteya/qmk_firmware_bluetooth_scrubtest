...
#define   _______________Ansi65__Row__4_______________    Q_RCTL, KC_LGUI,  KC_LALT,     SG_SPC1,        KC_RALT,  QK_LEAD,  Q_RCTL, KC_LEFT,  KC_DOWN,  KC_RGHT
...
#define   _______________Ansi65__Row__GBF1____________    C(S(KC_TAB)),  C(KC_TAB),  KC_MS_UP, KC_MS_BTN1, A(KC_LEFT), _______,  _______,  KC_HOME,  KC_UP,  KC_PGUP,  KC_APP,  _______,  _______,  _______,  _______
