...
#define _______________Alice65_Row__1NUM____________   S(C(KC_TAB)), C(KC_TAB), KC_MS_BTN2, KC_MS_UP, KC_MS_BTN1,  KC_MS_WH_UP, KC_NUM, KC_KP_7, KC_KP_8, KC_KP_9, KC_KP_MINUS, S(KC_MINS), _______, KC_DEL, KC_PGUP
...
#define _______________Alice65_Row__4NUM____________   TO(_BL), KC_MS_WH_DOWN, KC_MS_WH_UP, _______,           _______, _______,         _______, _______,          _______, _______, _______  
...
#define _______________Alice65_Row__4NAV____________   TO(_BL), KC_MS_WH_DOWN, KC_MS_WH_UP, QK_LEAD,           _______, _______,         _______, _______,          _______, _______, _______  
...
#define _______________Alice65_Row__4GBF____________   TO(_BL), _______, _______, _______,           _______, _______,         _______, _______,          _______, _______, _______  
...
#define _______________Alice65_Row__3MISC___________   _______, _______, KC_F2, KC_F5, KC_F12, _______, _______, _______, _______, _______, _______, _______, _______, _______  
#define _______________Alice65_Row__4MISC___________   TO(_BL), _______, _______, _______,           _______, _______,         _______, _______,          _______, _______, _______  
...
#define _______________Alice65_Row__4FN_____________   TO(_BL), _______, _______, _______,           _______, _______,         _______, _______,          _______, _______, _______  
