...
[WIN_BASE] = LAYOUT_ansi_68(
     GRABURL,  REFRESH,    KC_F2,    KC_F3,   KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,   KC_PRINT_SCREEN,  KC_PGUP,
     ...
     KC_TRNS, KC_MS_BTN1, KC_MS_LEFT,  KC_MS_DOWN,  KC_MS_UP,  KC_MS_RIGHT,  KC_LEFT,  KC_DOWN,  KC_UP,  KC_RGHT,  S(KC_7),  S(KC_2),            KC_TRNS,  KC_PGDN,
