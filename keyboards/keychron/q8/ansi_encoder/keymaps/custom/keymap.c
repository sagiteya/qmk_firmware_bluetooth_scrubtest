...
const uint16_t PROGMEM enterleft_combo[] = {KC_F,KC_V, COMBO_END};
const uint16_t PROGMEM enterright_combo[] = {KC_N,KC_J, COMBO_END};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_ansi_69(
        ...
        LCTL_T(KC_GRV), LT(_FN3,KC_A),       KC_S,     KC_D,    LT(_9,KC_F),    KC_G,              KC_H,    LT(_9,KC_J),    KC_K,    LT(_7,KC_L),     KC_SCLN,  KC_QUOT,  KC_ENT,         LALT_T(KC_END),
        ...
        TG(_7), KC_LGUI,  KC_LALT,           LT(_6,KC_SPC),           LT(_6,KC_SPC), LT(_6,KC_ENT),         KC_BSPC,            KC_RCTL,            KC_LEFT, KC_DOWN, KC_RGHT),
    ...
    [_FN3] = LAYOUT_ansi_69(
        ...
        RGB_TOG, _______,  KC_HOME,  KC_UP, KC_END, _______, _______,  _______, _______, _______, _______,  _______,  _______,  _______,          _______,
     ...
     [_6] = LAYOUT_ansi_69(
        ...
        _______, KC_F1,    KC_F2,    KC_F3,   KC_F4,   KC_F5,  _______,   KC_KP_7,  KC_KP_8,  KC_KP_9,  KC_KP_MINUS,  _______,  _______,  _______,          _______,
        _______,  KC_F6,    KC_F7,   KC_F8,   KC_F9,   KC_F10,  _______, KC_KP_4,  KC_KP_5,  KC_KP_6,  KC_KP_PLUS, _______,  _______,          _______,
        _______,           _______,  _______, _______, _______, KC_F12,  _______, KC_KP_0,  KC_KP_1,  KC_KP_2,  KC_KP_3,  KC_KP_DOT,  _______, _______,
        _______, _______,  _______,           _______,          _______,  _______,          _______,           _______,            _______, _______, _______),

    [_7] = LAYOUT_ansi_69(
        _______, KC_F1,    KC_F2,    KC_F3,   KC_F4,   KC_F5,   KC_F6,    KC_F7,   KC_F8,   KC_F9,   KC_F10,   KC_F11,   KC_F12,   _______,          _______,
        _______, _______,  KC_MS_BTN2,  KC_MS_UP, KC_MS_BTN1, KC_MS_WH_UP, _______,  _______, KC_UP, _______, _______,  _______,  _______,  _______,          _______,
        _______, _______, KC_MS_LEFT, KC_MS_DOWN, KC_MS_RIGHT, KC_MS_WH_DOWN,           _______, KC_LEFT, KC_RGHT, _______,  _______,  _______,  _______,          _______,
